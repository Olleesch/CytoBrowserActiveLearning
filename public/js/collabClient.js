...
const collabClient = (function(){
    ...
    function _handleAnnotationAction(msg) {
        switch(msg.actionType) {
            ...
            case "update":
                ...
                break;
            case "remove":
                annotationHandler.remove(msg.id, msg.annotationSet, false);
                break;
            case "clear":
    ...
    function _memberUpdate(hardUpdate = true) {
        ...
        layerHandler.updateMembers(_members.filter(member => member !== _localMember));
     ...
     */
    function removeAnnotation(id, annotationSet) {
        send({
            type: "annotationAction",
            actionType: "remove",
            id: id,
